        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-4">
            <div className="glass-card rounded-xl p-6 text-center" data-testid="bot-avatar">
              <img
                src="https://images.pexels.com/photos/7709109/pexels-photo-7709109.jpeg"
                alt="Sarthak AI Assistant"
              ...
              <p className="text-sm text-gray-600 mt-4">Multilingual Consular Assistant</p>
            </div>
          </div>
