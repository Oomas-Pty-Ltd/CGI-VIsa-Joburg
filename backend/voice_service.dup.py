    ...
    async def text_to_speech(self, text: str, language: str = "en", convert_numbers: bool = True) -> str:
        ...
        try:
            audio_base64 = await self.tts.generate_speech_base64(
                ...
                speed=0.95,
                instructions=(
                    "Speak like a cheerful, slightly quirky friend who genuinely loves helping people. "
                    "Be upbeat and warm — smile through your voice. Add a touch of playful energy, "
                    "like you're excited to share useful info. Use natural conversational rhythm — "
                    "speed up a little when enthusiastic, slow down gently on important details. "
                    "Pause briefly between thoughts as if chatting over coffee. "
                    "Never sound like a robot reading a script — sound like a real person who truly cares."
                )
            )
